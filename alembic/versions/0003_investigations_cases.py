...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("relationship", sa.String(64), server_default="related_to", nullable=False),
        ...
        sa.PrimaryKeyConstraint("id", name="pk_investigation_entities"),
        sa.ForeignKeyConstraint(
            ["investigation_id"],
            ["investigations.id"],
            ondelete="CASCADE",
            name="fk_investigation_entities_investigation",
        ),
    )
    op.create_index(
        "ix_investigation_entities_investigation", "investigation_entities", ["investigation_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column("id", uuid, server_default=sa.text("uuid_generate_v4()"), nullable=False),
        sa.Column("tenant_id", uuid, nullable=False),
        sa.Column("investigation_id", uuid),
        sa.Column("title", sa.String(512), nullable=False),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name="pk_case_tasks"),
        sa.ForeignKeyConstraint(
