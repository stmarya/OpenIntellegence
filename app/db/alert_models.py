...
class AlertRule(Base, TimestampMixin):
    """Tenant-scoped condition definition evaluated by future event workers."""
...
class Alert(Base, TimestampMixin):
    """One deduplicated, explainable alert occurrence."""
    ...
    first_triggered_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)
...
class Sighting(Base, TimestampMixin):
    """Observation of an entity in tenant telemetry or a partner feed."""
