...
from app.api.v1 import admin, ai, alerting, assets, automation_health, correlations, discovery, domains, entity_details, intel, orchestration, workflows
...
api_router.include_router(automation_health.router,tags=["Automation Health"])
